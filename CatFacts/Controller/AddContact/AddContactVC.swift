...
class AddContactVC: CFBaseVC {
    ...
    @IBAction func onClickAddContact(_ sender: AnyObject) {
        ...
        var _dicContact: [String: Any] = ["isActive":NSNumber(value: false as Bool), "sub":"sub", "name":self.txtName.text!, "phoneNumber":self.txtPhone.text!, "numberFactsSentPerDay":1]
